import type { Difficulty, Task } from '../../shared/types';
import tasksJson from '../../../data/tasks.json';

const tasks = tasksJson as Task[];

export function getRandomTask(difficulty: Difficulty): Task {
...
export function gradeAnswer(text: string, task: Task): { found: number, points: number, total: number } {
